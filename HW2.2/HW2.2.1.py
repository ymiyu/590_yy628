...
model_type="linear"; NFIT=3; X_KEYS=['x1']; Y_KEYS=['y']
...
def model(x,p):
	if(model_type=="linear"):   return linear(x, p)  
	if(model_type=="logistic"): return sigmoid(linear(x, p))
...
data = json.load(open('DATA/planar_x1_x2_x3_y.json', 'r'))
x1 = data['x1']
x2 = data['x2']
x3 = data['x3']
y = data['y']
